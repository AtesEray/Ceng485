...
const BuyerDashboard = () => {
    ...
    useEffect(() => {
        const initialize = async () => {
            try {
                ...
                const buyerContractAddress = '0x39b7B68e3e89d1dbBd8001a0806c411abBab7f13'; // Replace with the deployed Buyer contract address
    ...
    const buyVehicle = async () => {
        try {
            const web3 = await initWeb3();
            const buyerContractAddress = '0x39b7B68e3e89d1dbBd8001a0806c411abBab7f13'; // Replace with the deployed address
            const buyerContract = initContract(BuyerABI.abi, buyerContractAddress);
